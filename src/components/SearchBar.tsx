...
export const SearchBar = memo(function SearchBar({
  ...
  const containerClasses = isSearched
    ? 'w-full bg-container-L1 border-b border-stroke-low shadow-sm py-3 md:py-4'
        ...
        <div className={`flex flex-col gap-2 ${isSearched ? '' : ''}`}>
          ...
          {isSearched && (
            <div className="flex gap-1.5 md:gap-2 items-center">
              ...
              <button
                type="button"
                onClick={onToggleCollapse}
                className="p-1.5 md:px-2 md:py-2 bg-container-L2 text-icon-mid rounded-lg hover:bg-container-L3 hover:text-icon-high transition-colors border border-stroke-low flex-shrink-0"
              ...
              <button
                type="submit"
                className="p-1.5 md:px-6 md:py-3 bg-accent-teal-primary text-container-L0 rounded-lg hover:bg-accent-teal-secondary transition-colors font-medium shadow-sm hover:shadow-md flex items-center justify-center gap-2 flex-shrink-0"
                title="Explore"
              >
                <svg
                  className="w-4 h-4 md:w-5 md:h-5"
          ...
          {!isSearched && (
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center mt-4 md:mt-6">
              <button
                type="submit"
                className="px-6 py-2.5 md:py-3 bg-accent-teal-primary text-container-L0 rounded-lg hover:bg-accent-teal-secondary transition-colors font-medium shadow-sm hover:shadow-md flex items-center justify-center gap-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
